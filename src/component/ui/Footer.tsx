      ...
      <div className="mx-auto max-w-7xl">
        <div className="relative flex h-24 items-center justify-between">
          <button
            ...
            className="z-10 cursor-pointer text-[10px] tracking-[0.2em] uppercase transition-colors hover:text-orange-400"
          >
            Back to Top {'\u2191'}
          </button>
        ...
        <div className="mt-16 flex items-center justify-between border-t border-zinc-900/50 pt-8 text-[10px] text-white">
